...
export const TRANSLATIONS: Record<Language, any> = {
  ja: {
    ...
    exportReport: 'レポート送信',
    downloadCSV: 'CSV出力',
    emailPlaceholder: '送信先メールアドレス',
    deleteConfirm: '記録を削除しますか？',
    deletePasswordPrompt: '削除パスワード（0124）を入力してください',
    deletePasswordError: 'パスワードが正しくありません',
    saveSuccess: '保存完了',
    revenueError: '金額を入力してください',
    aiInsights: '✦ AI 経営診断',
    aiAnalyzeBtn: 'AIレポートを生成',
    aiAnalyzing: '診断中...',
    aiPlaceholder: '経営状況をAIが分析します。',
    aiError: 'AI分析は現在利用できません。Vercel等の環境変数で API_KEY が設定されているか確認してください。',
    yearly: '年度売上',
    quarterly: '四半期売上',
    monthly: '月間売上',
    q1: '第1四半期',
  ...
  en: {
    ...
    exportReport: 'Send Email',
    downloadCSV: 'Download CSV',
    emailPlaceholder: 'Recipient Email',
    deleteConfirm: 'Delete this record?',
    deletePasswordPrompt: 'Enter deletion password (0124)',
    deletePasswordError: 'Incorrect password',
    saveSuccess: 'Saved!',
    revenueError: 'Enter amount',
    aiInsights: '✦ AI Strategy',
    aiAnalyzeBtn: 'Generate Diagnosis',
    aiAnalyzing: 'Analyzing...',
    aiPlaceholder: 'AI will analyze business status.',
    aiError: 'AI analysis unavailable. Check API_KEY environment variable.',
    yearly: 'Yearly Rev',
    ...
    q3: 'Q3',
    q4: 'Q4',
    revenueTrend: 'Revenue Growth Curve',
    tours: {
